...
📝 Author
Developed by a 10th-grade student as an engineering research project in robotics and computer vision.
...
📝 Автор
Проект выполнен учеником 10-го класса в рамках инженерно-исследовательской работы по направлению «Робототехника и ИИ».
